...
export const ANIMAL_PUZZLES: AnimalPuzzleSet[] = [
  ...
  // ── Prospect Park ─────────────────────────────────────────────────────────
  {
    ...
    puzzles: [
      ...
      { type: 'choice', question: 'Squirrels bury acorns to save them for winter. What is this food-saving behavior called?', choices: ['Caching', 'Migrating', 'Molting'], correct: 0 },
  ...
  },
  {
    ...
    puzzles: [
      ...
      { type: 'choice', question: "A dog's nose is 100,000× more sensitive than a human's. If you can smell a fresh pie from 1 foot away, how far away could a dog smell it?", choices: ['1,000 feet', '100,000 feet', '1,000,000 feet'], correct: 1 },
  ...
  // ── Brooklyn Heights ──────────────────────────────────────────────────────
  {
    ...
    puzzles: [
      ...
      { type: 'truefalse', statement: 'Cats have a special body twist called the "righting reflex" that helps them land feet-first when they fall from a height.', isTrue: true },
      ...
      { type: 'choice', question: 'Cleo purrs for 3 minutes then naps for 12 minutes, then repeats. After 3 purr-nap cycles, how much time has passed in total?', choices: ['36 min', '45 min', '39 min'], correct: 1 },
  ...
  },
  {
    ...
    puzzles: [
      ...
      { type: 'choice', question: 'Raccoons can open jars, turn doorknobs, and even unzip backpacks with their paws. What word describes animals that can use their hands skillfully?', choices: ['Dexterous', 'Nocturnal', 'Herbivorous'], correct: 0 },
  ...
  // ── Central Park ──────────────────────────────────────────────────────────
  {
    ...
    puzzles: [
      ...
      { type: 'choice', question: 'Rabbits thump their back feet loudly to warn other rabbits of danger. What is this type of behavior called?', choices: ['An alarm signal', 'A mating call', 'Echolocation'], correct: 0 },
  ...
  // ── Staten Island ─────────────────────────────────────────────────────────
  {
    ...
    puzzles: [
      ...
      { type: 'choice', question: 'Chipmunks have stripes on their backs that help them blend into sun-dappled ground. What is this type of coloring called?', choices: ['Camouflage', 'Bioluminescence', 'Molting'], correct: 0 },
    ],
  },
  {
    animalId: 'deer',
    ...
    puzzles: [
      ...
      { type: 'choice', question: 'A white-tailed deer can jump 8 feet high and 30 feet far in a single leap. If Daisy needs to cross a stream that is 25 feet wide, how many extra feet of distance does she have?', choices: ['5 feet', '3 feet', '8 feet'], correct: 0 },
  ...
  },
  {
    ...
    puzzles: [
      ...
      { type: 'choice', question: 'Beaver dams block rivers to create deep ponds. What human-built structure works the same way?', choices: ['A dam (like Hoover Dam)', 'A lighthouse', 'A skyscraper'], correct: 0 },
  ...
  },
  {
    ...
    puzzles: [
      ...
      { type: 'choice', question: 'A hummingbird weighs about 0.1 ounce — lighter than a penny! How many hummingbirds would weigh the same as 1 pound of birdseed (16 ounces)?', choices: ['80', '160', '320'], correct: 1 },
  ...
  },
  {
    ...
    puzzles: [
      ...
      { type: 'choice', question: 'Skunks have limited spray — a skunk can spray exactly 5 times before needing 10 days to recharge. If Stella has already sprayed twice today, how many sprays does she have left?', choices: ['2', '3', '4'], correct: 1 },
  ...
  },
  {
    ...
    bonusXP: 25,
    puzzles: [
      { type: 'choice', question: 'A bobcat can leap 12 feet horizontally — about the length of a car! If Bobby needs to jump across a 9-foot creek, how many extra feet of distance does he have?', choices: ['2 feet', '3 feet', '4 feet'], correct: 1 },
  ...
  },
  {
    ...
    puzzles: [
      ...
      { type: 'choice', question: 'Moose are surprisingly fast swimmers at 6 mph. If Magnus swims across a lake that is 3 miles wide, how many minutes does the crossing take?', choices: ['20 minutes', '30 minutes', '60 minutes'], correct: 1 },
    ],
  },
  {
    animalId: 'loon',
    ...
    puzzles: [
      ...
      { type: 'choice', question: 'Luna carries her 2 chicks on her back for their first 2 weeks. If she catches 8 fish per day to feed them, how many fish does she catch for her chicks during that time?', choices: ['56 fish', '112 fish', '128 fish'], correct: 1 },
  ...
  },
  {
    ...
    puzzles: [
      ...
      { type: 'choice', question: 'Wolves belong to the Canidae (dog) family. Which of these is also a member of the dog family?', choices: ['Fox', 'Bear', 'Raccoon'], correct: 0 },
  ...
  },
  {
    ...
    puzzles: [
      ...
      { type: 'choice', question: 'Humpback whales are mammals that breathe air, nurse their young, and have warm blood. Which of these facts proves they are NOT fish?', choices: ['They breathe air with lungs, not gills', 'They are very large', 'They live in the ocean'], correct: 0 },
  ...
  // ── Hidden animals ─────────────────────────────────────────────────────────
  {
    ...
    puzzles: [
      ...
      { type: 'choice', question: "Groundhogs are called 'woodchucks' — a word that comes from a Native American word 'wuchak.' What does this teach us about animal names?", choices: ['They often come from many languages and cultures', 'Groundhogs are related to woodpeckers', 'They love to chew wood'], correct: 0 },
  ...
  },
  {
    ...
    puzzles: [
      ...
      { type: 'choice', question: 'Great blue herons tuck their necks into an "S" shape during flight — unlike most birds that fly with necks stretched out. Why might this help them fly?', choices: ['It makes them more streamlined and aerodynamic', 'It helps them see fish below while flying', 'It keeps their neck warm in cold air'], correct: 0 },
      ...
      { type: 'choice', question: 'Herons nest in colonies called rookeries high in trees. If 20 pairs of herons each raise 3 chicks, how many total birds are in the rookery?', choices: ['60 birds', '100 birds', '80 birds'], correct: 1 },
    ],
  },
  {
    animalId: 'sandpiper',
    ...
    puzzles: [
      ...
      { type: 'choice', question: 'Sandpipers have special nerve endings in their bill tips that can feel tiny vibrations underground. What are they detecting?', choices: ['Buried worms and clams moving in the sand', 'Seeds growing into plants', 'Waves coming toward shore'], correct: 0 },
      ...
      { type: 'which', question: 'Sandpipers share the beach with many other birds. Which of these also wades along the shoreline to find food?', choices: ['🦩', '🦚', '🦜'], correct: 0 },
    ],
  },
  {
    animalId: 'firefly',
  ...
  // ── Cancún & Riviera Maya ────────────────────────────────────────────────────
  {
    ...
    puzzles: [
      ...
      { type: 'choice', question: 'Sea turtles are one of the few reptiles that spend almost their entire lives in the ocean. What must they come ashore to do?', choices: ['Lay their eggs in nests on the beach', 'Drink fresh water', 'Shed their shells'], correct: 0 },
  ...
  },
  {
    ...
    puzzles: [
      ...
      { type: 'choice', question: 'Flamingos eat by filtering tiny creatures from water through comb-like plates in their beaks. Which ocean giant uses a very similar feeding method?', choices: ['Baleen whale', 'Great white shark', 'Giant octopus'], correct: 0 },
  ...
  // ── Hong Kong, China ─────────────────────────────────────────────────────────
  {
    ...
    puzzles: [
      ...
      { type: 'choice', question: 'Ship engine noise in Hong Kong harbor makes it hard for Pearl to use echolocation. How does this noise pollution affect dolphins?', choices: ['They cannot find food or communicate as easily', 'They swim faster to escape the noise', 'It makes their skin change color'], correct: 0 },
