    ...
    World(
        ...
        levels: [
            ...
            Level(id: "cp-5", worldId: "city-park", levelNumber: 5,
                  ...
                  grid: buildGrid(size: 5,
                      obstacles: [(0, 2, .rock), (1, 0, .bush), (1, 2, .rock), (1, 4, .bush),
                                  (2, 2, .water), (3, 1, .rock), (3, 3, .bush), (4, 1, .rock)],
                      stars: [(0, 4), (3, 4)],
                      start: (0, 0), habitat: (4, 4)),
                  startPosition: GridPosition(row: 0, col: 0),
                  habitatPosition: GridPosition(row: 4, col: 4),
                  starPositions: [GridPosition(row: 0, col: 4), GridPosition(row: 3, col: 4)],
    ...
    World(
        ...
        levels: [
            ...
            Level(id: "fm-5", worldId: "forest", levelNumber: 5,
                  ...
                  grid: buildGrid(size: 6,
                      obstacles: [(0, 2, .tree), (0, 4, .rock), (1, 1, .tree), (2, 3, .rock), (2, 5, .tree),
                                  (3, 0, .tree), (3, 2, .rock), (3, 4, .tree), (4, 1, .rock), (4, 5, .tree)],
                      stars: [(1, 5), (5, 0)],
                      start: (0, 0), habitat: (5, 5)),
                  startPosition: GridPosition(row: 0, col: 0),
                  habitatPosition: GridPosition(row: 5, col: 5),
    ...
    World(
        ...
        levels: [
            ...
            Level(id: "bo-5", worldId: "beach", levelNumber: 5,
                  ...
                  grid: buildGrid(size: 6,
                      obstacles: [(0, 2, .wave), (0, 4, .seaweed), (1, 1, .rock), (1, 4, .wave),
                                  (2, 0, .seaweed), (2, 3, .wave), (3, 1, .wave), (3, 5, .seaweed),
                                  (4, 0, .wave), (4, 3, .rock), (4, 4, .seaweed)],
                      stars: [(2, 5), (5, 1)],
                      start: (0, 0), habitat: (5, 5)),
                  startPosition: GridPosition(row: 0, col: 0),
                  habitatPosition: GridPosition(row: 5, col: 5),
                  starPositions: [GridPosition(row: 2, col: 5), GridPosition(row: 5, col: 1)],
                  optimalPathLength: 14),
        ],
    ...
    World(
        ...
        levels: [
            ...
            Level(id: "ta-3", worldId: "tropical", levelNumber: 3,
                  ...
                  grid: buildGrid(size: 7,
                      obstacles: [(0, 2, .rock), (0, 5, .vine), (1, 0, .vine), (1, 4, .rock),
                                  (2, 2, .vine), (2, 6, .ruins), (3, 1, .rock), (3, 3, .vine), (3, 5, .rock),
                                  (4, 0, .vine), (4, 4, .ruins), (5, 2, .rock), (5, 6, .vine)],
                      stars: [(1, 6), (6, 1)],
                      start: (0, 0), habitat: (6, 6)),
                  startPosition: GridPosition(row: 0, col: 0),
                  habitatPosition: GridPosition(row: 6, col: 6),
                  starPositions: [GridPosition(row: 1, col: 6), GridPosition(row: 6, col: 1)],
                  optimalPathLength: 15),
            ...
            Level(id: "ta-5", worldId: "tropical", levelNumber: 5,
                  ...
                  grid: buildGrid(size: 7,
                      obstacles: [(0, 2, .vine), (0, 4, .ruins), (1, 0, .vine), (1, 3, .rock), (1, 6, .vine),
                                  (2, 2, .ruins), (2, 5, .vine), (3, 0, .rock), (3, 3, .vine), (3, 4, .rock),
                                  (4, 1, .vine), (4, 5, .ruins), (4, 6, .rock),
                                  (5, 0, .vine), (5, 3, .rock), (5, 5, .vine)],
                      stars: [(2, 6), (6, 0)],
                      start: (0, 0), habitat: (6, 6)),
                  startPosition: GridPosition(row: 0, col: 0),
                  habitatPosition: GridPosition(row: 6, col: 6),
                  starPositions: [GridPosition(row: 2, col: 6), GridPosition(row: 6, col: 0)],
                  optimalPathLength: 16),
        ],
