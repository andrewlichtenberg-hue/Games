    ...
    World(
        ...
        levels: [
            ...
            Level(id: "cp-3", worldId: "city-park", levelNumber: 3,
                  ...
                  optimalPathLength: 8),
            // cp-4: Stars at (2,4) and (1,2), both on the shortest path.
            // Path: (0,0)→(0,1)→(0,2)→(1,2)★→(2,2)→(2,3)→(2,4)★→(3,4)→(4,4) = 8 steps
            Level(id: "cp-4", worldId: "city-park", levelNumber: 4,
                  ...
                  startPosition: GridPosition(row: 0, col: 0),
                  habitatPosition: GridPosition(row: 4, col: 4),
                  starPositions: [GridPosition(row: 2, col: 4), GridPosition(row: 1, col: 2)],
                  optimalPathLength: 8),
    ...
    World(
        ...
        levels: [
            ...
            Level(id: "fm-3", worldId: "forest", levelNumber: 3,
                  ...
                  optimalPathLength: 10),
            // fm-4: Stars at (5,1) and (2,1), both reachable without backtracking.
            // Path: (0,0)→(0,1)→(0,2)→(1,2)→(2,2)→(2,1)★→(3,1)→(4,1)→(5,1)★→(5,2)→(5,3)→(5,4)→(5,5) = 12 steps
            Level(id: "fm-4", worldId: "forest", levelNumber: 4,
                  ...
                  startPosition: GridPosition(row: 0, col: 0),
                  habitatPosition: GridPosition(row: 5, col: 5),
                  starPositions: [GridPosition(row: 2, col: 1), GridPosition(row: 5, col: 1)],
    ...
    World(
        ...
        levels: [
            ...
            Level(id: "bo-2", worldId: "beach", levelNumber: 2,
                  ...
                  optimalPathLength: 10),
            // bo-3: Stars at (5,0) and (4,2), both reachable without backtracking.
            // Via (5,0): (0,0)→...→(4,0)→(5,0)★→(5,1)→(5,2)→(5,3)→(5,4)→(5,5) = 12 steps
            // Via (4,2): (0,0)→...→(4,1)→(4,2)★→(5,2)→... = 12 steps
            Level(id: "bo-3", worldId: "beach", levelNumber: 3,
                  ...
                  startPosition: GridPosition(row: 0, col: 0),
                  habitatPosition: GridPosition(row: 5, col: 5),
                  starPositions: [GridPosition(row: 5, col: 0), GridPosition(row: 4, col: 2)],
                  optimalPathLength: 12),
            // bo-4: Stars at (1,4) and (3,5), both on the optimal path.
            // Path: (0,0)→(0,1)→(0,2)→(1,2)→(1,3)→(1,4)★→(2,4)→(3,4)→(3,5)★→(4,5)→(5,5) = 10 steps
            Level(id: "bo-4", worldId: "beach", levelNumber: 4,
                  ...
                  startPosition: GridPosition(row: 0, col: 0),
                  habitatPosition: GridPosition(row: 5, col: 5),
                  starPositions: [GridPosition(row: 1, col: 4), GridPosition(row: 3, col: 5)],
                  optimalPathLength: 10),
